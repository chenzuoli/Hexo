...
![etcd_log](一致性共识算法ETCD解析/etcd-log.png)
...
![etcdv2](一致性共识算法ETCD解析/etcd-v2.png)
...
![etcdv3](一致性共识算法ETCD解析/etcd-v3.png)
...
<a>[<font color=#0099ff>raft官网</font>](https://raft.github.io) 有论文地址以及相关资料。
<a>[<font color=#0099ff>raft动画演示</font>](http://wetech.top/2019/09/29/%E4%B8%80%E8%87%B4%E6%80%A7%E5%85%B1%E8%AF%86%E7%AE%97%E6%B3%95Raft%E5%9B%BE%E6%96%87%E8%AF%A6%E8%A7%A3/) 看了这个动画就懂raft了。
<a>[<font color=#0099ff>Interval_tree</font>](https://en.wikipedia.org/wiki/Interval_tree)
<a>[<font color=#0099ff>etcd](https://www.infoq.cn/article/etcd-interpretation-application-scenario-implement-principle/)：从应用场景到实现原理的全方位解读 这篇文章对使用场景描述的比较全面。
<a>[<font color=#0099ff>confd</font>](https://github.com/yunify/confd) 我们修改版的confd仓库地址。
<a>[<font color=#0099ff>metad</font>](https://github.com/yunify/metad) 仓库地址。
<a>[<font color=#0099ff>etcd集群一键搭建脚本</font>](https://gist.github.com/jolestar/6644dee696dcdce432caa46705ddc7ba)
<a>[<font color=#0099ff>并发之痛</font>](http://jolestar.com/parallel-programming-model-thread-goroutine-actor/) Thread，Goroutine，Actor 本人关于并发模型的一篇文章，有利于理解文章内提到的CSP模型。
